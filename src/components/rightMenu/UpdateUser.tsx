        ...
        <div className="absolute w-screen h-screen top-0 left-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          >
            ...
            <div className="mt-4 text-xs text-gray-500">
              Use o perfil da navegação para atualizar o avatar ou o nome de
              usuário.
            </div>
            <CldUploadWidget
              uploadPreset="social"
                ...
                return (
                  <div className="flex flex-col gap-4 my-4">
                    ...
                    >
                      ...
                      />
                      <span className="text-xs underline text-gray-4=600">
                        Trocar
                      </span>
                    </div>
                  </div>
            ...
            <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  type="text"
                  name="surname"
                  placeholder={user.surname || 'Sobrenome'}
                  className="ring-1 ring-gray-300 p-3 rounded-md text-sm"
                />
              </div>
              <div className="flex flex-col gap-4">
                ...
                <input
                  type="text"
                  name="description"
                  placeholder={user.description || 'Descrição'}
                  className="ring-1 ring-gray-300 p-3 rounded-md text-sm"
                />
              </div>
              <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <input
                  type="text"
                  name="school"
                  placeholder={user.school || 'Estudo'}
                  className="ring-1 ring-gray-300 p-3 rounded-md text-sm"
                />
              </div>
              <div className="flex flex-col gap-4">
                ...
                <input
                  type="text"
                  name="work"
                  placeholder={user.work || 'Trabalho'}
                  className="ring-1 ring-gray-300 p-3 rounded-md text-sm"
                />
              </div>
              <div className="flex flex-col gap-4">
            ...
            {state.error && (
              <span className="text-red-500 text-xs">Algo deu errado!</span>
            )}
            <div
